...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/Sebalvarez97/mutants/src/main/bundle/mutant/controller"
...
func TestGetIsMutant(t *testing.T) {
	...
	t.Run("Success Mutant", func(t *testing.T) {
		...
		controller.Service = MutantServiceImplMock{}
...
func TestIsMutantValidationIssues(t *testing.T) {
